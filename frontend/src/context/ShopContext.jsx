...
const getDefaultCart = () => {
  ...
  for (let index = 0; index < all_product.length+1; index++) { // loop through each product in all_products. it starts with the index 0, and continues until it reaches the length of all_product array
